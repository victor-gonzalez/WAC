...
#include "../Best/BestAnalysisConfiguration.hpp"
...
TFile* getSampleFile(BestAnalysisConfiguration* conf, int irap, int iPtRange, int isample)
{
  TFile* f = nullptr;
...
TDirectory* getSampleDirectory(BestAnalysisConfiguration* conf, TFile* file, TString& taskname, int irap, int iptrange, const char* cname)
{
...
TList* extractSampleResults(Option_t* opt, BestAnalysisConfiguration* conf, TFile* samplefile, AnalysisConfiguration* ac, int irap, int iptrange, std::string evfltr, int isample)
{
